            ...
            <section>
                ...
                <div class="tablacitasPac">
                    ...
                    <tr class="">
                        ...
                        <!-- Agregamos boton para actualizar  -->
                        <td class="regCitasPac"><a href="actualizarCita.php?id=<?PHP echo $citas->id_cita?>"><input type="button" name="btnUpdate" value="Actualizar" class="regCitasPac" ></a></td>
