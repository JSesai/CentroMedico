        ...
        <main>
            <section>
                <article>
                    ...
                    <select name='idMedico'>
                        <option selected>Medico</option>
                            ...
                            <?php
                                ...
                                $registros= $bds->query('SELECT id_medico, nombre, apellidoPaterno, especialidad FROM medicos')->fetchAll(PDO::FETCH_OBJ);
                    ...
                    <option value="<?PHP echo $citas->id_medico?>"><?PHP  echo $citas->nombre." ". $citas->apellidoPaterno. " - ".$citas->especialidad?></option>
